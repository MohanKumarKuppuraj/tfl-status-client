...
namespace TFLClientTest {
	...
	public class TFLClientUnitTest{
		...
		public void Test_RoadStatus_ResponseHandler_Success_Result(){
			...
			Assert.Equal("Closure",response.results["statusSeverity"]);
			Assert.Equal("Closure",response.results["statusSeverityDescription"]);
		...
		public void Test_RoadStatus_ResponseHandler_Failure_Result(){
			...
			Assert.False(response.results.ContainsKey("statusSeverity"));
			Assert.False(response.results.ContainsKey("statusSeverityDescription"));
